 ...
 * @author User
 */
public class sucNomember extends javax.swing.JFrame {

    /**
     * Creates new form sucNomember
     */
    public sucNomember() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sucNomember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sucNomember().setVisible(true);
            }
        });
    }
