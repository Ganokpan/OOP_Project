...
public class Member extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        phone.setFont(new java.awt.Font("Angsana New", 0, 18)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Integer.parseInt(jLabelpoint.getText()) < 300) {
            System.out.println(Integer.parseInt(jLabelpoint.getText()));            
            sucNomember sucs = new sucNomember();
            String total2 = Double.toString(total);
            sucs.price.setText(total2);
sucs.setVisible(true);setVisible(false); 
        } else {
            Checkpro pro = new Checkpro();
            pro.Name.setText(Jlabelname1.getText());
             pro.telePhone.setText(phone.getText());
            pro.setVisible(true);setVisible(false); 
            pro.point.setText(jLabelpoint.getText());
            int k = Integer.parseInt(pro.point.getText());
            if (k >= 300) {
                if (k < 500) {

                    pro.usepoint.setText("300");
                    pro.jLabel5.setText("5");

                } else if (k >= 500) {
                    pro.jLabel5.setText("10");
                    pro.usepoint.setText("500");
