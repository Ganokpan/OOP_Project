...
public class check extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!(Menu2.Numchick.getText()).equals("0")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            suc2 Suc = new suc2();
            System.out.println(Menu2.Numchick.getText());
            if (!(Menu2.Numchick.getText()).equals("0")) {
                String data[] = {"ไก่ทอด", Menu2.Numchick.getText(), "60", String.format("%d", (Integer.parseInt(Menu2.Numchick.getText())) * 60)};
            ...
            if (j >= 300) {
                ...
                if (j >= 300 && j < 500) {
                    ...
                    Suc.pointUsed.setText(String.format("%.2f", p1));
                    Suc.price.setText(String.format("%.2f", total1));
                    setVisible(false);
                    System.out.println("ออกก300");
                    Suc.jLabel11name.setText(Name1.getText());
                    Suc.jLabel12tel.setText(telephone.getText());
